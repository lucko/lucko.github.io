...
export default function Home() {
  return (
    <Layout>
      ...
      <p>Among other things, I'm a software developer and maintain/contribute to a number of open source projects in my spare time.</p>
      <p>If you'd like to contact me, you can reach out via <a href="mailto:hey@lucko.me">email</a> or <a href="https://discord.gg/Rnbpc7s">Discord</a>.</p>
      <p className="message">I try my best to reply to all messages, but unfortunately I often don't have enough time respond to everything. If you have a question about one of my projects, please use the <Link href="/contact">advertised support systems</Link> before attempting to contact me directly!</p>
      <p>My <Link href="/pgp">PGP key</Link> has the fingerprint <code>EFA9 B3EC 5FD9 0F8B</code> and my <Link href="/ssh">SSH key</Link> has the fingerprint <code>08:64:2f:da:cf:c1:b8:64:04:bb:d3:08:08:05:11:2a</code>.</p>
      ...
      <p>I try my best to keep these services available. Most have been online and had good uptime for the past ~3 years at least.</p>
      ...
      <ul>
        ...
        <li>At time of writing, it's been downloaded ~1.5M times, has ~250,000 monthly active users, and a Discord community of ~12,000 people.</li>
      ...
      <ul>
        <li>spark is a performance profiling plugin/mod for Minecraft clients, servers and proxies, written in Java.</li>
        <li>There is also a web viewer component, <a href="https://github.com/lucko/spark-viewer">spark-viewer</a>, written using React.</li>
      ...
      <ul>
        <li>helper is a Bukkit plugin development toolkit/library. It provides a number of utilities and extended APIs to support rapid and easy development of plugins.</li>
        <li>I'm not currently working on further API additions, but the project is still being used frequntly by various development teams, and I accept pull requests!</li>
      </ul>
      ...
      <ul>
        ...
        <li>You can think of it a bit like a <a href="https://en.wikipedia.org/wiki/Pastebin">pastebin</a>, except that it accepts any kind of data (not just plain text!)</li>
      </ul>
