  ...
  return (
    <Layout title="contact">
      <article>
        ...
        <h3>Other</h3>
        <p>If your question / message doesn't fall into any of the categories above, feel free to
          reach out via <a href="mailto:hey@lucko.me">email</a> or <a href="https://discord.gg/Rnbpc7s">Discord</a>.</p>
      </article>
    </Layout>
  )
}
